...
Benchmarks compare TurboQuantDB against reference vector-store engines on a real-world embedding dataset. Engines are identified by their index algorithm; reproduction scripts are in `benchmarks/`.
...
| **Engine-A** (HNSW) | 33.5s | 1,493 | 398 MB | 924 MB | 258% | 92% | 2.41ms | 3.42ms | 99.75% | 1.0000 |
...
| Engine-B (IVF-PQ) | 89.8s | 556 | 318 MB | 1,722 MB | 1100% | 152% | 8.10ms | 9.57ms | 79.90% | 1.0000 |
| Engine-D (HNSW) | 251.4s | 198 | 391 MB | 493 MB | 2% | 7% | 12.18ms | 14.20ms | 100.00% | 1.0000 |
| Engine-E (HNSW) | 407.2s | 122 | 745 MB | 1,597 MB | 132% | 193% | 177.00ms | 195.46ms | 100.00% | 1.0000 |
| Engine-C (HNSW)† | 805.0s | 62 | 685 MB | 1,152 MB | 7% | 1000% | 123.94ms | 163.84ms | 100.00% | 1.0000 |

† Engine-C in embedded mode — not representative of its server deployment.
...
|--------|------|-----------|-----------|------------|
| Engine-E | 745 MB | 15,619 | 0.39× smaller | 0.53× |
| Engine-C | 685 MB | 14,373 | 0.43× smaller | 0.58× |
| Engine-A | 398 MB | 8,353 | 0.74× smaller | baseline |
| Engine-D | 391 MB | 8,203 | 0.75× smaller | 1.02× |
| Engine-B | 318 MB | 6,663 | 0.92× smaller | 1.25× |
...
|--------|--------|-------|------|-----|---------|---------|-----|-----|----------|
| Engine-A (HNSW) | 30.6s | 1,633 | 398 MB | 865 MB | 244% | 100% | 1.73ms | 2.44ms | 99.75% |
...
| Engine-B (IVF-PQ) | 77.6s | 644 | 318 MB | 526 MB | 1067% | 155% | 9.17ms | 10.51ms | 79.50% |
| Engine-C (HNSW)† | 538.2s | 92 | 685 MB | 1,151 MB | 17% | 130% | 179.88ms | 186.80ms | 100.00% |
...
|--------|--------|-------|------|-----|-----|-----|----------|-------|
| Engine-A (HNSW) | 84.2s | 594 | 398 MB | 906 MB | 2.88ms | 4.11ms | 99.75% | 1.0000 |
...
| Engine-B (IVF-PQ) | 214.9s | 232 | 318 MB | 1,220 MB | 37.09ms | 64.50ms | 80.50% | 1.0000 |
| Engine-C (HNSW)† | 854.1s | 58 | 685 MB | 1,151 MB | 105.81ms | 139.18ms | 100.00% | 1.0000 |
